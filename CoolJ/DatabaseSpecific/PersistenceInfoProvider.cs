...
namespace NinjaSoftware.EnioNg.CoolJ.DatabaseSpecific
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		private void InitArtiklEntityMappings()
		{
			...
			this.AddElementFieldMapping("ArtiklEntity", "ArtiklId", "ArtiklId", false, "Bigint", 0, 19, 0, true, "public.GenericSequence", null, typeof(System.Int64), 0);
		...
		private void InitAuditInfoEntityMappings()
		{
			...
			this.AddElementFieldMapping("AuditInfoEntity", "AuditInfoId", "AuditInfoId", false, "Bigint", 0, 19, 0, true, "public.GenericSequence", null, typeof(System.Int64), 2);
		...
		private void InitBrojacEntityMappings()
		{
			...
			this.AddElementFieldMapping("BrojacEntity", "BrojacId", "BrojacId", false, "Bigint", 0, 19, 0, true, "public.GenericSequence", null, typeof(System.Int64), 0);
		...
		private void InitErrorEntityMappings()
		{
			...
			this.AddElementFieldMapping("ErrorEntity", "ErrorId", "ErrorId", false, "Bigint", 0, 19, 0, true, "public.GenericSequence", null, typeof(System.Int64), 2);
		...
		private void InitPartnerEntityMappings()
		{
			...
			this.AddElementFieldMapping("PartnerEntity", "PartnerId", "PartnerId", false, "Bigint", 0, 19, 0, true, "public.GenericSequence", null, typeof(System.Int64), 6);
		...
		private void InitPdvEntityMappings()
		{
			...
			this.AddElementFieldMapping("PdvEntity", "PdvId", "PdvId", false, "Bigint", 0, 19, 0, true, "public.GenericSequence", null, typeof(System.Int64), 2);
		...
		private void InitRacunStavkaEntityMappings()
		{
			...
			this.AddElementFieldMapping("RacunStavkaEntity", "RacunStavkaId", "RacunStavkaId", false, "Bigint", 0, 19, 0, true, "public.GenericSequence", null, typeof(System.Int64), 9);
		...
		private void InitTarifaEntityMappings()
		{
			...
			this.AddElementFieldMapping("TarifaEntity", "TarifaId", "TarifaId", false, "Bigint", 0, 19, 0, true, "public.GenericSequence", null, typeof(System.Int64), 4);
		}
		...
		private void InitUserEntityMappings()
		{
			...
			this.AddElementFieldMapping("UserEntity", "UserId", "UserId", false, "Bigint", 0, 19, 0, true, "public.GenericSequence", null, typeof(System.Int64), 3);
