...
namespace NinjaSoftware.EnioNg.CoolJ.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			switch((PdvFieldIndex)fieldIndex)
			{
				case PdvFieldIndex.FirmaId:
		...
		{
			this.PerformDesetupSyncRelatedEntity( _firma, new PropertyChangedEventHandler( OnFirmaPropertyChanged ), "Firma", NinjaSoftware.EnioNg.CoolJ.RelationClasses.StaticPdvRelations.FirmaEntityUsingFirmaIdStatic, true, signalRelatedEntity, "PdvCollection", resetFKFields, new int[] { (int)PdvFieldIndex.FirmaId } );
			_firma = null;
		}
		...
		private void SetupSyncFirma(IEntityCore relatedEntity)
		{
			if(_firma!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _firma, new PropertyChangedEventHandler( OnFirmaPropertyChanged ), "Firma", NinjaSoftware.EnioNg.CoolJ.RelationClasses.StaticPdvRelations.FirmaEntityUsingFirmaIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(FirmaEntityFactory))),	(IEntityRelation)GetRelationsForField("Firma")[0], (int)NinjaSoftware.EnioNg.CoolJ.EntityType.PdvEntity, (int)NinjaSoftware.EnioNg.CoolJ.EntityType.FirmaEntity, 0, null, null, null, null, "Firma", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The FirmaId property of the Entity Pdv<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Pdv"."FirmaId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		[JsonProperty]
		public virtual System.Int64 FirmaId
		{
			get { return (System.Int64)GetValue((int)PdvFieldIndex.FirmaId, true); }
			set	{ SetValue((int)PdvFieldIndex.FirmaId, value); }
		}
		...
		public virtual FirmaEntity Firma
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "PdvCollection", "Firma", _firma, true); 
				}
			}
		}
