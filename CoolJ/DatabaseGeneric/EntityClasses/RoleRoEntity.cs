...
namespace NinjaSoftware.EnioNg.CoolJ.EntityClasses
{
			...
			
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<UserEntity>(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))), (IEntityRelation)GetRelationsForField("KorisnikCollection")[0], (int)NinjaSoftware.EnioNg.CoolJ.EntityType.RoleRoEntity, (int)NinjaSoftware.EnioNg.CoolJ.EntityType.UserEntity, 0, null, null, null, null, "KorisnikCollection", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{ 
			get { return (int)NinjaSoftware.EnioNg.CoolJ.EntityType.RoleRoEntity; }
		}
