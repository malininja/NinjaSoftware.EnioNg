...
namespace NinjaSoftware.EnioNg.CoolJ.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected override void PerformDesyncSetupFKFieldChange(int fieldIndex)
		{
			...
			{
				case PartnerFieldIndex.FirmaId:
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(FirmaEntityFactory))),	(IEntityRelation)GetRelationsForField("Firma")[0], (int)NinjaSoftware.EnioNg.CoolJ.EntityType.PartnerEntity, (int)NinjaSoftware.EnioNg.CoolJ.EntityType.FirmaEntity, 0, null, null, null, null, "Firma", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The FirmaId property of the Entity Partner<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Partner"."FirmaId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		[JsonProperty]
		public virtual System.Int64 FirmaId
		{
			get { return (System.Int64)GetValue((int)PartnerFieldIndex.FirmaId, true); }
			set	{ SetValue((int)PartnerFieldIndex.FirmaId, value); }
		}
		...
		public virtual FirmaEntity Firma
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "PartnerCollection", "Firma", _firma, true); 
				}
			}
		}
